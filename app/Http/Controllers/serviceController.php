                ...
                switch ($payload){
                    ...
                    case 'send_feedback': //to 11
                        ...
                        if ($orders->toArray() == []){
                            ...
                            $text = "Выберите заказ из списка и отправьте его номер. \n Список заказов: \n ";
                            foreach ($orders as $order) {
                                $text = $text . $order->id . ') Заказ от ' . $order->created_at . "\n";
                    ...
                    if (is_numeric($message)){
                        ...
                        if(isset($product->id)){
                            ...
                            if($product->category_id!=$d_info->spec_info){
                                $text="Выбранный товар не из этой категории, но тоже у нас имеется! \n ";
                            }
                            ...
                            $text=$text.$product->name.' - '.$product->price."р \n ".$product->description;
                            if($service_id == 2){
                ...
                switch ($payload){
                    case 'order_info':    //to 8
                        ...
                        if ($orders->toArray() == []){
                            ...
                            $text="Введите номер заказа для просмотра содержимого. \n Заказы в обработке: \n ";
                            foreach ($orders as $order){
